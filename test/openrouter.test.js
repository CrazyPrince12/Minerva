...
// Le fallback par défaut pour OpenRouter est maintenant "openrouter/free" (routeur automatique).
assert.equal(resolveRoute(UNCENSORED).provider.id, "openrouter");
assert.deepEqual(resolveRoute(UNCENSORED).models, [UNCENSORED, "openrouter/free"]);
